...
export function NuevoBeneficiario({ idContrato, listaEstadosCivil, idUsuario, idTerreno }: BeneficiarioProps) {
    const { toast } = useToast();
    const router = useRouter();
    const [abreviatura, setAbreviatura] = useState<string>("SR.");
    const [nombreBeneficiario, setNombreBeneficiario] = useState<string>("");
    ...
    function guardarBeneficiario() {
        const data = {
            ...
            nombre: nombreBeneficiario != null ? nombreBeneficiario.toUpperCase() : null,
            ...
            lugar_nacimiento: lugarNacimiento != null ? lugarNacimiento.toUpperCase() : null,
            ocupacion: ocupacion != null ? ocupacion.toUpperCase() : null,
            ...
            tel_cod_trabajo: codigoTrabajo != null ? codigoTrabajo : null,
            tel_trabajo: telTrabajo != null ? telTrabajo : null,
            ...
            nacionalidad: nacionalidad != null ? nacionalidad.toUpperCase() : null,
        ...
        const crearBeneficiario = async () => {
            try {
                const response = await fetch(`/api/dashboard/ventas/prospecto/creaBeneficiario`, {
                    method: "POST",
                    headers: {
                ...
                if (!response.ok) {
                    toast({
                        ...
                        title: "Error",
                        description: "Por favor, comprueba los datos, el beneficiario no puede ser agregado",
                        duration: 2500,
                        variant: "destructive",
                    });
                ...
                if (result) {
                    ...
                    toast({
                        // Llama a la función toast
                        title: "Éxito",
                        description: "Beneficiario guardado correctamente",
                        duration: 2500,
                        variant: "default",
                        style: {
                            background: "#25D366",
            ...
            <Dialog>
                ...
                <DialogContent className=" md:max-w-full sm:min-w-[430px] lg:max-w-[70%] h-[85%]">
                    <ScrollArea className="h-6/6 w-full rounded-md border p-4">
                        <DialogHeader>
                            <DialogTitle className="text-center uppercase text-black"></DialogTitle>
                            ...
                            <DialogDescription>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                                    <div className="md:col-span-12 lg:col-span-12 xl:col-span-12 text-center my-3">
                                    ...
                                    <div className="md:col-span-2 lg:col-span-2 xl:col-span-2">
                                        <Label htmlFor="nombreBeneficiario">Nombre(s)</Label>
                                        <Input
                                            ...
                                            className="uppercase"
                                            onChange={(event) => setNombreBeneficiario(event.target.value.toUpperCase())}
                                        />
                                    </div>
                                    <div className="md:col-span-2 lg:col-span-2 xl:col-span-2">
                                    ...
                                    <div className="md:col-span-2 lg:col-span-2 xl:col-span-2">
                                        ...
                                        <Input
                                            id="fechaNacimiento"
                                            placeholder={
                                                fechaNacimiento ? moment(fechaNacimiento, "YYYY-MM-DD").format("DD/MM/YYYY") : "dd/mm/aaaa"
                                            }
                                            className="uppercase"
