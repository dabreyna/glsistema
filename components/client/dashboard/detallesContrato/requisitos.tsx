...
export default function Requisitos({ idUsuario, idCliente }: ReferenciaProps) {
    ...
    const handleSave = async (documento: string) => {
        ...
        console.log(selectedFile, idCliente, idContrato, idTerreno, documento);
    ...
    return (
        <>
            <Card>
                ...
                <CardFooter>{/* <BtnTerminarVenta idCliente={idCliente} idContrato={idContrato} /> */}</CardFooter>
            </Card>
        </>
    );
}
