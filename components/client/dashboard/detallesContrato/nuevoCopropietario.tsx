...
export function NuevoCopropietario({ idContrato, listaEstadosCivil, idUsuario, idTerreno }: CopropietarioProps) {
                            ...
                            <DialogDescription>
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                                    ...
                                    <div className="md:col-span-2 lg:col-span-2 xl:col-span-2">
                                        ...
                                        <Checkbox
                                            id="chkPrincipal"
                                            checked={chkPrincipal}
                                            onCheckedChange={(e) => setChkPrincipal(!chkPrincipal)}
                                        />
                                        <Label htmlFor="chkPermiso"> Permiso </Label>
                                        <Checkbox
                                            id="chkPermiso"
                                            checked={chkPermiso}
                                            onCheckedChange={(e) => setChkPermiso(!chkPermiso)}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 py-6 ">
                                    <div className="md:col-span-6 lg:col-span-6 xl:col-span-6 text-right my-3">
                                        <Button
                                            className="p-6"
                                            id="btnGuardarCopropietario"
                                            disabled={estadoBtn}
                                            onClick={guardarCopropietario}
                                        >
