...
export default function Beneficiario({ idContrato, listaEstadosCivil, idUsuario, idTerreno }: BeneficiarioProps) {
    ...
    return (
        <>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                <div className="md:col-span-12 lg:col-span-12 xl:col-span-12 text-center my-3">DATOS DEL BENEFICIARIO</div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 py-6 ">
                <div className="md:col-span-6 lg:col-span-6 xl:col-span-6 text-right my-3">
                    <Button className="p-6" id="btnGuardarBeneficiario" disabled={estadoBtn} onClick={guardarBeneficiario}>
