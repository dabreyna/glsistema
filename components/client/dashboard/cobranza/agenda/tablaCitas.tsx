...
export default function TablaCitas({ listaClasificacion, idUsuario, perfilUsuario }: AgendaProps) {
    ...
    return (
        <>
            ...
            <Table id="tablaDatos" className="rounded-md border-2 border-slate-200 shadow-sm">
                ...
                <TableBody>
                    <TableRow key={listadoCitas[0]?.nombre_asesor} className="shadownc-table__row my-row">
                        <TableCell colSpan={9} className="font-medium text-sm bg-slate-100" style={{ height: "10px", padding: 2 }}>
                            {listadoCitas[0]?.nombre_asesor}
                        </TableCell>
                    </TableRow>
