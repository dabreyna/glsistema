...
const generaTest = async (idDOC: number) => {
    console.log(idDOC);
};
export default function GeneraDOC() {
    ...
    return (
        <>
            {/* <Button onClick={() => generateDocument(datosContrato)}>Contrato</Button> //ES LA ORIGINAL */}
            <Button variant="link" onClick={() => generaTest(1)}>
                Aviso 1 Mes Vencido
            </Button>
            <Button variant="link" onClick={() => generaTest(2)}>
                Aviso 2 Meses Vencidos
            </Button>
            <Button variant="link" onClick={() => generaTest(3)}>
                Aviso 3 Meses Vencidos
            </Button>
            <Button variant="link" onClick={() => generaTest(4)}>
                Aviso 4 Meses Vencidos
            </Button>
            <Button variant="link" onClick={() => generaTest(5)}>
                Convenio de Pago
            </Button>
            <Button variant="link" onClick={() => generaTest(6)}>
                Cancelacion sin devolucion
            </Button>
            <Button variant="link" onClick={() => generaTest(7)}>
                Cancelacion con devolucion
            </Button>
        </>
    );
}
