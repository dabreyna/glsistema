...
export default function TablaDatos() {
  const comentarios = useComentariosCobranzaFiltrosConsultaStore((state) => state.resultados);
      ...
      <Table id="tablaDatos" className="rounded-md border-2 border-slate-200 shadow-sm max-w-[full]">
        ...
        <TableHeader className="border-2 border-slate-200 shadow-lg">
          <TableRow>
            ...
            <TableHead className="text-center">Fecha comentario</TableHead>
            <TableHead className="text-center">Comentario</TableHead>
            <TableHead className="text-center">Atencion</TableHead>
        ...
        <TableBody>
          <>
            {comentarios.map((comentario) => (
              <TableRow key={`${comentario.consecutivo}`} className="hover:bg-slate-100 hover:font-semibold hover:cursor-pointer">
                <TableCell className="text-left max-w-[150px] uppercase">{comentario.asesor}</TableCell>
                <TableCell className="text-center max-w-[150px] uppercase">{comentario.nombre_cliente}</TableCell>
                <TableCell className="text-center max-w-[20px]">{comentario.fecha_comentario}</TableCell>
                <TableCell className="text-center max-w-[500px]">{comentario.comentario}</TableCell>
                <TableCell className="text-center max-w-[60px]">{comentario.atendido}</TableCell>
                <TableCell className="text-center max-w-[60px]">{comentario.donde}</TableCell>
              </TableRow>
            ))}
          </>
        </TableBody>
