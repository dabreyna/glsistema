    ...
    return (
        <>
            ...
            <Table id="tablaDatos" className="rounded-md border-1 border-slate-200 shadow-sm max-w-[full] mx-auto border-2">
                <TableCaption>GRUPO LOTIFICADORA - DEVOLUCIONES PROGRAMADAS- </TableCaption>
                <TableHeader>
                    {/* <TableRow>
                    ...
                    <TableRow>
                        ...
                        <TableHead className="text-center">Saldo a devolver</TableHead>
                        <TableHead className="text-center">No. Pago</TableHead>
                        <TableHead className="text-center">Fecha devolución</TableHead>
                        <TableHead className="text-center">Monto</TableHead>
                        <TableHead className="text-center">Fecha contrato</TableHead>
                        <TableHead className="text-center">Fecha cancelación</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
