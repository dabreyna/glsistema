...
export default function FiltrosConsultaEstadoDeCuenta({ listaFraccionamientos }: FiltrosConsultaProps) {
    const seleccionaResultados = useEstadoDeCuentaFiltrosConsultaStore((state: { setResultados: any }) => state.setResultados);
