    ...
    return (
        <>
            ...
            <Table id="tablaDatos" className="rounded-md border-1 border-slate-200 shadow-sm max-w-[full] mx-auto border-2">
                <TableCaption>GRUPO LOTIFICADORA - ESTADISTICO- </TableCaption>
                <TableHeader>
                    {/* <TableRow>
                        <TableHead className="text-center" colSpan={12}></TableHead>
                    </TableRow> */}
                    <TableRow>
                        <TableHead className="text-center">Manzana</TableHead>
                        <TableHead className="text-center"># de terrenos</TableHead>
                        <TableHead className="text-center">Valor total</TableHead>
                        <TableHead className="text-center">Contratado</TableHead>
                        <TableHead className="text-center">Total contratado</TableHead>
                        <TableHead className="text-center">Deposito inicial</TableHead>
                        <TableHead className="text-center">Depositos por referencia</TableHead>
                        <TableHead className="text-center">Descuentos</TableHead>
                        <TableHead className="text-center">Total</TableHead>
                        <TableHead className="text-center">Contratado por cobrar</TableHead>
