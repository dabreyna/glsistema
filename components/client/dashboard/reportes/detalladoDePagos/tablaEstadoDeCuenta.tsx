              ...
              <TableRow key={`${resultado.id_contrato}`} className="hover:bg-slate-100 hover:font-semibold hover:cursor-pointer">
                ...
                <TableCell colSpan={1} className="text-center">
                  {new Intl.NumberFormat("es-MX", {
                    ...
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }).format(Number(resultado.pagos))}
                </TableCell>
                <TableCell colSpan={1} className="text-right items-center">
                  {new Intl.NumberFormat("es-MX", {
                    style: "currency",
                    currency: "MXN",
                    minimumFractionDigits: 2,
                ...
                <TableCell className="text-center">{resultado.mensualidades_pagadas}</TableCell>
              </TableRow>
            ))}
          </>
        </TableBody>
