...
export default function FiltrosConsultaSaldosCuentasPorCobrar({ listaFraccionamientos }: FiltrosConsultaProps) {
    const seleccionaResultados = useSaldosCuentasPorCobrarConsultaStore((state: { setResultados: any }) => state.setResultados);
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(
                    `/api/dashboard/reportes/saldosCuentasPorCobrar?idFraccionamiento=${fraccionamiento}&chkHistorico=${chkHistorico}&fInicio=${fInicio}&fFin=${fFin}`
                );
                if (!response.ok) {
