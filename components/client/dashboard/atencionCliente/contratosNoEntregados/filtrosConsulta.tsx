        ...
        const fetchData = async () => {
            try {
                const response = await fetch(
                    `/api/dashboard/reportes/saldosVencidos?idFraccionamiento=${fraccionamiento}&fInicio=${fInicio}&fFin=${fFin}&mensualidades=${mensualidades}&nombreCliente=${nombreCliente}&chkDolares=${chkDolares}&chkServicio=true`
                );
                if (!response.ok) {
