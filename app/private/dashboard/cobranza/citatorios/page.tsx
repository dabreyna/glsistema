...
import FiltrosConsultaCitatorios from "@/components/client/dashboard/cobranza/citatorios/filtrosConsulta";

export default async function Citatorios() {
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaCitatorios listaFraccionamientos={listaFraccionamientos} />
                                            <TablaDatos />
                                        </CardContent>
                                    </Card>
                                </div>
