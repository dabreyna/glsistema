...
import FiltrosConsulta from "@/components/client/dashboard/cobranza/cartaDevolucion/filtrosConsulta";
                ...
                <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-1 lg:gap-8">
                    <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                        <Card x-chunk="dashboard-contenedor-reporte">
                            <CardHeader>
                                <CardTitle className="text-center">CARTA DEVOLUCION</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <>
                                                <FiltrosConsulta
                                                    idUsuario={Number(session.user.id_usuario)}
                                                    perfilUsuario={Number(session.user.perfil_usuario)}
                                                />
                                            </>
                                        </CardContent>
                                    </Card>
