...
import { getPolizas } from "@/lib/contabilidad/polizas";

// import TablaDatos from "@/components/client/dashboard/reportes/detalladoDePagos/tablaDatos";
import TablaDatos from "@/components/client/dashboard/contabilidad/tablaDatos";
...
export default async function ContabilidadPage() {
    ...
    const listaPolizas = await getPolizas();
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosContabilidad listaEmpresas={listaEmpresas} />
                                            <TablaDatos listaPolizas={listaPolizas} listaEmpresas={listaEmpresas} />
                                        </CardContent>
                                    </Card>
                                </div>
                            </CardContent>
