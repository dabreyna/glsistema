...
import { getAsesores, getClasificacion } from "@/lib/reportes/bitacoraDeLlamadas/filtrosBusqueda";
import TablaDatos from "@/components/client/dashboard/reportes/bitacoraDeLlamadas/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";
import FiltrosConsultaBitacoraDeLlamadas from "@/components/client/dashboard/reportes/bitacoraDeLlamadas/filtrosConsulta";

export default async function BitacoraDeLlamadas() {
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaBitacoraDeLlamadas
