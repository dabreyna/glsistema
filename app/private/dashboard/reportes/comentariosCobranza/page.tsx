...
import { getUsuarios, getUsuariosInactivos } from "@/lib/reportes/reporteCobranza/filtrosBusqueda";

// import TablaDatos from "@/components/client/dashboard/reportes/detalladoDePagos/tablaDatos";
import TablaDatos from "@/components/client/dashboard/reportes/comentariosCobranza/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";
import FiltrosConsultaComentariosCobranza from "@/components/client/dashboard/reportes/comentariosCobranza/filtrosConsulta";
...
export default async function ReporteCobranza() {
  ...
  const listaUsuariosInactivos = await getUsuariosInactivos();
              ...
              <CardContent>
                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                  <Card className="col-span-12">
                    ...
                    <CardContent>
                      <FiltrosConsultaComentariosCobranza listaUsuarios={listaUsuarios} listaUsuariosInactivos={listaUsuariosInactivos} />
                      <TablaDatos />
                    </CardContent>
                  </Card>
                </div>
