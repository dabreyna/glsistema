...
import { getAsesores } from "@/lib/reportes/asignacionCarga/filtrosBusqueda";

// import TablaDatos from "@/components/client/dashboard/reportes/detalladoDePagos/tablaDatos";
import TablaDatos from "@/components/client/dashboard/reportes/asignacionCarga/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";
import FiltrosConsultaReporteAsignacionCarga from "@/components/client/dashboard/reportes/asignacionCarga/filtrosConsulta";

export default async function ReporteAsignacionCarga() {
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaReporteAsignacionCarga listaAsesores={listaAsesores} />
                                            <TablaDatos />
                                        </CardContent>
                                    </Card>
                                </div>
