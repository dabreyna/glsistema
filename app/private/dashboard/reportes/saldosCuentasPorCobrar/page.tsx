...
import TablaDatos from "@/components/client/dashboard/reportes/saldosCuentasPorCobrar/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";
import FiltrosConsultaSaldosCuentasPorCobrar from "@/components/client/dashboard/reportes/saldosCuentasPorCobrar/filtrosConsulta";
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaSaldosCuentasPorCobrar listaFraccionamientos={listaFraccionamientos} />
                                            <TablaDatos />
                                        </CardContent>
                                    </Card>
                                </div>
