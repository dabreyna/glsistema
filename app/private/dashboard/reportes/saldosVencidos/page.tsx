...
import FiltrosConsultaSaldosVencidos from "@/components/client/dashboard/reportes/saldosVencidos/filtrosConsulta";
import TablaDatos from "@/components/client/dashboard/reportes/saldosVencidos/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";

export default async function SaldosVencidos() {
              ...
              <CardContent>
                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                  <Card className="col-span-12">
                    ...
                    <CardContent>
                      <FiltrosConsultaSaldosVencidos listaFraccionamientos={listaFraccionamientos} />
                      <TablaDatos />
                    </CardContent>
                  </Card>
                </div>
