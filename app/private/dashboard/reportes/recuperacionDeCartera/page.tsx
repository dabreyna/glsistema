...
import TablaDatos from "@/components/client/dashboard/reportes/recuperacionDeCartera/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";
import FiltrosConsultaReporteRecuperacionDeCartera from "@/components/client/dashboard/reportes/recuperacionDeCartera/filtrosConsulta";
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaReporteRecuperacionDeCartera listaEmpresas={listaEmpresas} />
                                            <TablaDatos />
                                        </CardContent>
                                    </Card>
                                </div>
