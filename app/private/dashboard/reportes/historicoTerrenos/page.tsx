...
import TablaDatos from "@/components/client/dashboard/reportes/historicoTerrenos/tablaDatos";

import FiltrosConsultaHistoricoDeTerrenos from "@/components/client/dashboard/reportes/historicoTerrenos/filtrosConsulta";
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaHistoricoDeTerrenos listaFraccionamientos={listaFraccionamientos} />
                                            <TablaDatos />
                                        </CardContent>
                                    </Card>
                                </div>
