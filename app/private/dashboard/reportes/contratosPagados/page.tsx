...
import TablaDatos from "@/components/client/dashboard/reportes/contratosPagados/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";
import FiltrosConsultaContratosPagados from "@/components/client/dashboard/reportes/contratosPagados/filtrosConsulta";
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaContratosPagados listaFraccionamientos={listaFraccionamientos} />
                                            <TablaDatos />
                                        </CardContent>
                                    </Card>
                                </div>
