...
import TablaDatos from "@/components/client/dashboard/reportes/estadisticoDetalle/tablaDatos";

// import TablaDatosDetallada from "@/components/client/dashboard/reportes/comisiones/tablaDatosDetallada";
import FiltrosConsultaReporteRecuperacionDeCartera from "@/components/client/dashboard/reportes/estadisticoDetalle/filtrosConsulta";
                            ...
                            <CardContent>
                                <div className="grid gap-6 md:grid-cols-6 sm:grid-cols-6">
                                    <Card className="col-span-12">
                                        ...
                                        <CardContent>
                                            <FiltrosConsultaReporteRecuperacionDeCartera
