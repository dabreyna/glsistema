...
export async function GET(request: NextRequest) {
    ...
    if (idServicio != "" && idServicio != "0") {
        servicioSeleccionado = ` and a.id_servicio=${idServicio}`;
    }
    ...
    if (chkServicio != "" && chkServicio != "false") {
        const fraccionamiento = idFraccionamiento != "0" ? ` e.ID_FRACCIONAMIENTO=${idFraccionamiento} ` : "1=1";
        const pesos = chkDolares != "false" ? " and i.moneda=1" : " and coalesce(i.moneda,0)=0";
             ...
             select distinct ID_CLIENTE,ID_CONTRATO,Terreno,nombre_cliente,fecha_contrato,SERVICIO,mes1,mes2,mes3,mes4,dia_vencimiento,mensualidades_vencidas,
              ...
              from(
                ...
                FROM MOVIMIENTOS_DETALLE a
                  ...
                  WHERE
                  ${fraccionamiento} --si se borra esta condicion se puede obtener los servicios de todos los fraccionamientos
