...
export async function GET(request: NextRequest) {
    ...
    const diasGracia = 8;
    const where = "";
    const query = `select aa.* from (SELECT NO_PAGO,to_char(fecha_movimiento,'dd/MM/yyyy') AS FECHA_MOVIMIENTO,B.MOVIMIENTO,a.MONTO_SALDO
                   ...
                   ${where}
                   order by aa.fecha_movimiento::date asc,aa.no_pago asc
                   `;
